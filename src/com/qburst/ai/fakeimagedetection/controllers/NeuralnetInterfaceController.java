package com.qburst.ai.fakeimagedetection.controllers;

import com.jfoenix.controls.JFXButton;
import com.jfoenix.controls.JFXSnackbar;
import com.qburst.ai.fakeimagedetection.metadataextractor.MetadataProcessor;
...
import com.qburst.ai.fakeimagedetection.neural_network.imageprocessor.ErrorLevelAnalyzer;
import com.qburst.ai.fakeimagedetection.neuralnetwork.threadsync.ThreadCompleteListener;
import ij.ImagePlus;
...
public class NeuralnetInterfaceController implements Initializable, ThreadCompleteListener {
    ...
    ErrorLevelAnalyzer elaAnalyzer;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        elaAnalyzer = new ErrorLevelAnalyzer(imageLocation, 95);
                ...
                EventHandler handler = new EventHandler() {
                    ...
                    public void handle(Event event) {
                        ...
                        if (result.get() == fakeButton) {
                            ...
                            SingleImageLearner learner
                                    = new SingleImageLearner(NeuralNetProcessor.nnet, elaImage, false);
                            ...
                            navigation_button.setText("Learning...");
                            SingleImageLearner learner
                                    = new SingleImageLearner(NeuralNetProcessor.nnet, elaImage, true);
                            learner.addListener(thisObject);
                            learner.setName("learner");
                            learner.start();
                        } else {
