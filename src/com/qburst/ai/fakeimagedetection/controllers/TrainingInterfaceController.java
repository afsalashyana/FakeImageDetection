...
import com.qburst.ai.fakeimagedetection.neuralnetwork.core.training.NeruralTrainer;
...
public class TrainingInterfaceController implements Initializable {
        ...
        switch (startButton.getAccessibleText()) {
            case "start":
                try {
                    ...
                    neuralTrainer = new NeruralTrainer(srcDir, nnFile,
