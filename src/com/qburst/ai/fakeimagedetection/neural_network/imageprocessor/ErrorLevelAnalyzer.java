package com.qburst.ai.fakeimagedetection.neural_network.imageprocessor;
...
public class ErrorLevelAnalyzer extends NotifyingThread {
    ...
    public ErrorLevelAnalyzer(String fileLocation, int quality) {
        this.fileLocation = fileLocation;
        this.quality = quality;
        this.sampledDimension = new Dimension(100, 100);
    }

    public ErrorLevelAnalyzer(String fileLocation, int quality, Dimension sampledDimension) {
        this.fileLocation = fileLocation;
        this.quality = quality;
