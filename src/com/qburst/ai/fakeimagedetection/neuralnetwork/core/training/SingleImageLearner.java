...
public class SingleImageLearner extends NotifyingThread implements LearningEventListener {
    ...
    public SingleImageLearner(NeuralNetwork nnet, BufferedImage image, Boolean isReal) {
        this.nnet = nnet;
        this.image = image;
        this.isReal = isReal;
